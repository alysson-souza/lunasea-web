...
* Pinned the project to Flutter 3.41.9 through FVM.
* Updated Flutter Web bootstrapping to use the generated `flutter_bootstrap.js` loader.
...
* The historical LunaSea changelog is preserved below for upstream release context.
* This fork is now focused on the browser/PWA build; native app release notes below do not describe current build targets.
