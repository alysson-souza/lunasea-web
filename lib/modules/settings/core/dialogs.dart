...
class SettingsDialogs {
        ...
        Form(
          ...
          child: LunaDialog.textFormInput(
            ...
            validator: (value) {
              ...
              if (LunaServiceEndpoint.isValidDirectHost(value!)) {
                return null;
              }
        ...
        Form(
          ...
          child: LunaDialog.textFormInput(
            ...
            validator: (value) {
              // Allow empty value
              if (value?.isEmpty ?? true) return null;
              // Test for https://, http://, or relative proxy route (e.g. /api/radarr)
              RegExp exp = RegExp(r"^(https?:\/\/|\/)", caseSensitive: false);
  ...
  Future<Tuple2<bool, String>> editGatewayUpstream(
    BuildContext context, {
    String upstream = '',
  }) async {
    bool flag = false;
    final formKey = GlobalKey<FormState>();
    final upstreamController = TextEditingController()..text = upstream;
            ...
            children: [
              LunaDialog.textFormInput(
                ...
                validator: (value) {
                  ...
                  return 'settings.UpstreamURLValidation'.tr();
                },
              ),
            ],
          ),
    ...
    return Tuple2(flag, upstreamController.text);
  }

  Future<Tuple2<bool, String>> editGatewayApiKey(BuildContext context) async {
    bool flag = false;
    final formKey = GlobalKey<FormState>();
        ...
        Form(
          ...
          child: LunaDialog.textFormInput(
            ...
            validator: (value) {
              ...
              return 'settings.ApiKeyRequired'.tr();
            },
          ),
        ),
      ],
    ...
    return Tuple2(flag, apiKeyController.text);
  }

  Future<Tuple3<bool, String, String>> editGatewayCredentials(
    BuildContext context,
  ) async {
    bool flag = false;
    final formKey = GlobalKey<FormState>();
          ...
          child: Column(
            children: [
              LunaDialog.textFormInput(
                ...
                validator: (value) {
                  if (value?.isNotEmpty ?? false) return null;
                  return 'settings.UsernameValidation'.tr();
                },
              ),
              LunaDialog.textFormInput(
                ...
                validator: (value) {
                  if (value?.isNotEmpty ?? false) return null;
                  return 'settings.PasswordValidation'.tr();
                },
              ),
            ],
          ),
    ...
    return Tuple3(flag, usernameController.text, passwordController.text);
  }
  ...
  Future<bool> deleteGatewayConnection(BuildContext context) async {
    bool flag = false;
    ...
    await LunaDialog.dialog(
      ...
      content: [
        LunaDialog.textContent(
          text: 'settings.DeleteGatewayConnectionHint1'.tr(),
        ),
      ],
      contentPadding: LunaDialog.textDialogContentPadding(),
    );
  ...
  Future<Tuple2<bool, LunaModule?>> selectBootModule() async {
    ...
    final modules = LunaModule.values.filter((module) {
      final enabled = profiles.isEnabled(module);
