      ...
      child: LunaListView(
        ...
        children: [
          LunaHeader(
            text: 'Daily',
            subtitle: [
              'Last ${TautulliPreferences.GRAPHS_LINECHART_DAYS.read()} Days',
              '\n\n',
          ...
          LunaHeader(
            text: 'Monthly',
            subtitle: [
              'Last ${TautulliPreferences.GRAPHS_MONTHS.read()} Months',
              '\n\n',
          ...
          LunaHeader(
            text: 'By Day Of Week',
            subtitle: [
              'Last ${TautulliPreferences.GRAPHS_DAYS.read()} Days',
              '\n\n',
