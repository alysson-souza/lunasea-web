...
class SonarrDialogs {
  ...
  Future<bool> searchAllMissingEpisodes(BuildContext context) async {
    ...
    await LunaDialog.dialog(
      ...
      content: [
        LunaDialog.textContent(text: 'sonarr.MissingEpisodesHint1'.tr()),
      ],
    ...
    await LunaDialog.dialog(
      ...
      content: [
        Consumer<SettingsStore>(
          builder: (context, settings, _) => LunaDialog.checkbox(
            title: 'sonarr.AddToExclusionList'.tr(),
            value: settings.sonarrRemoveSeriesExclusionList,
            onChanged: (value) => context
                .read<SettingsStore>()
                .setSonarrRemoveSeriesExclusionList(value!),
          ),
        ),
        Consumer<SettingsStore>(
          builder: (context, settings, _) => LunaDialog.checkbox(
            title: 'sonarr.DeleteFiles'.tr(),
            value: settings.sonarrRemoveSeriesDeleteFiles,
            onChanged: (value) => context
                .read<SettingsStore>()
                .setSonarrRemoveSeriesDeleteFiles(value!),
          ),
        ),
      ],
      contentPadding: LunaDialog.listDialogContentPadding(),
      ...
      content: [
        Builder(
          builder: (context) {
            ...
            if (state != null) {
              return Consumer<SonarrSeriesAddDetailsState>(
                builder: (context, state, _) => LunaDialog.checkbox(
            ...
            return Consumer<SettingsStore>(
              builder: (context, settings, _) => LunaDialog.checkbox(
                title: 'sonarr.StartSearchForMissingEpisodes'.tr(),
                value: settings.sonarrAddSeriesSearchForMissing,
                onChanged: (value) => context
                    .read<SettingsStore>()
                    .setSonarrAddSeriesSearchForMissing(value!),
              ),
            );
          },
        ),
        Builder(
          builder: (context) {
            ...
            return Consumer<SettingsStore>(
              builder: (context, settings, _) => LunaDialog.checkbox(
                title: 'sonarr.StartSearchForCutoffUnmetEpisodes'.tr(),
                value: settings.sonarrAddSeriesSearchForCutoffUnmet,
                onChanged: (value) => context
                    .read<SettingsStore>()
                    .setSonarrAddSeriesSearchForCutoffUnmet(value!),
              ),
            );
          },
        ),
      ...
      content: [
        Consumer<SettingsStore>(
          builder: (context, settings, _) => LunaDialog.checkbox(
            ...
            value: settings.sonarrQueueRemoveDownloadClient,
            onChanged: (value) => context
                .read<SettingsStore>()
                .setSonarrQueueRemoveDownloadClient(value!),
          ),
        ),
        Consumer<SettingsStore>(
          builder: (context, settings, _) => LunaDialog.checkbox(
            title: 'sonarr.AddReleaseToBlocklist'.tr(),
            value: settings.sonarrQueueAddBlocklist,
            onChanged: (value) => context
                .read<SettingsStore>()
                .setSonarrQueueAddBlocklist(value!),
          ),
        ),
      ],
      contentPadding: LunaDialog.listDialogContentPadding(),
  ...
  Future<Tuple2<bool, int>> setQueuePageSize(BuildContext context) async {
    ...
    TextEditingController _textController = TextEditingController(
      text: SonarrPreferences.QUEUE_PAGE_SIZE.read().toString(),
    );
