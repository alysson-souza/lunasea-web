  ...
  Future<bool> removeSeries({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context
          ...
          .delete(
            seriesId: series.id!,
            deleteFiles: SonarrPreferences.REMOVE_SERIES_DELETE_FILES.read(),
            addImportListExclusion: SonarrPreferences
          ...
          .then((_) async {
            return await context
                ...
                .then((_) {
                  if (showSnackbar)
                    showLunaSuccessSnackBar(
                      title: SonarrPreferences.REMOVE_SERIES_DELETE_FILES.read()
