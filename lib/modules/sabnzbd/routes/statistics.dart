...
class _State extends State<StatisticsRoute> with LunaScrollControllerMixin {
  ...
  Future<SABnzbdStatisticsData> _fetch() async =>
      SABnzbdAPI.from(context.read<ProfilesStore>().active).getStatistics();
  ...
  Widget _statistics() {
    return BackendPreferenceGroupCard(
      content: [
        BackendPreferenceGroupContent(
            title: 'Daily', body: _data!.dailyUsage.asBytes()),
        BackendPreferenceGroupContent(
            title: 'Weekly', body: _data!.weeklyUsage.asBytes()),
        BackendPreferenceGroupContent(
            title: 'Monthly', body: _data!.monthlyUsage.asBytes()),
        BackendPreferenceGroupContent(
            title: 'Total', body: _data!.totalUsage.asBytes()),
      ],
    );
  }
