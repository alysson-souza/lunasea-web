...
enum LunaSeaPreferences<T> with BackendPreference<T> {
  ...
  @override
  BackendPreferenceGroup get table => BackendPreferenceGroup.lunasea;

  @override
  final T fallback;

  const LunaSeaPreferences(this.fallback);
  @override
  dynamic export() {
    LunaSeaPreferences db = this;
    switch (db) {
      case LunaSeaPreferences.DRAWER_MANUAL_ORDER:
