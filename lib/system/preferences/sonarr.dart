...
enum SonarrPreferences<T> with BackendPreference<T> {
  ...
  @override
  BackendPreferenceGroup get table => BackendPreferenceGroup.sonarr;

  @override
  final T fallback;

  const SonarrPreferences(this.fallback);
  @override
  dynamic export() {
    SonarrPreferences db = this;
    switch (db) {
      case SonarrPreferences.DEFAULT_SORTING_SERIES:
        return SonarrPreferences.DEFAULT_SORTING_SERIES.read().key;
      case SonarrPreferences.DEFAULT_SORTING_RELEASES:
        return SonarrPreferences.DEFAULT_SORTING_RELEASES.read().key;
      case SonarrPreferences.DEFAULT_FILTERING_SERIES:
        return SonarrPreferences.DEFAULT_FILTERING_SERIES.read().key;
      case SonarrPreferences.DEFAULT_FILTERING_RELEASES:
        return SonarrPreferences.DEFAULT_FILTERING_RELEASES.read().key;
      case SonarrPreferences.DEFAULT_VIEW_SERIES:
        return SonarrPreferences.DEFAULT_VIEW_SERIES.read().key;
      default:
        return super.export();
    }
  }
