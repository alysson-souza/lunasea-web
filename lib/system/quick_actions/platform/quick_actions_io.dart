...
class IO implements LunaQuickActions {
  ...
  void setActionItems() {
    _quickActions.setShortcutItems(<ShortcutItem>[
      if (LunaSeaPreferences.QUICK_ACTIONS_TAUTULLI.read())
        LunaModule.TAUTULLI.shortcutItem,
      if (LunaSeaPreferences.QUICK_ACTIONS_SONARR.read())
        LunaModule.SONARR.shortcutItem,
      if (LunaSeaPreferences.QUICK_ACTIONS_SEARCH.read())
        LunaModule.SEARCH.shortcutItem,
      if (LunaSeaPreferences.QUICK_ACTIONS_SABNZBD.read())
        LunaModule.SABNZBD.shortcutItem,
      if (LunaSeaPreferences.QUICK_ACTIONS_RADARR.read())
        LunaModule.RADARR.shortcutItem,
      if (LunaSeaPreferences.QUICK_ACTIONS_OVERSEERR.read())
        LunaModule.OVERSEERR.shortcutItem,
      if (LunaSeaPreferences.QUICK_ACTIONS_NZBGET.read())
        LunaModule.NZBGET.shortcutItem,
      if (LunaSeaPreferences.QUICK_ACTIONS_LIDARR.read())
