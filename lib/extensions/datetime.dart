...
extension DateTimeExtension on DateTime {
  ...
  String asTimeOnly() {
    if (LunaSeaPreferences.USE_24_HOUR_TIME.read()) return _formatted('Hm');
  ...
  String asDateTime({
    ...
    format
        .write(LunaSeaPreferences.USE_24_HOUR_TIME.read() ? 'HH:mm' : 'hh:mm');
    if (showSeconds) format.write(':ss');
    if (!LunaSeaPreferences.USE_24_HOUR_TIME.read()) format.write(' a');
