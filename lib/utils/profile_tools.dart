...
class LunaProfileTools {
  final ProfilesStore _profiles;

  LunaProfileTools(this._profiles);
  ...
  Future<bool> changeTo(
    ...
    try {
      if (_profiles.activeProfile == profile) return true;
  ...
  Future<void> _changeTo(String profile) async {
    ...
    await _profiles.changeTo(profile);
    LunaState.reset();
  }
  ...
  Future<void> _remove(String profile) async {
    if (_profiles.activeProfile == profile) {
  ...
  Future<void> _rename(String oldProfile, String newProfile) async {
    if (!_profiles.contains(oldProfile)) {
    ...
    await _profiles.rename(oldProfile, newProfile);
