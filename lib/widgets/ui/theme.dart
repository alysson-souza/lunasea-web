...
class LunaTheme {
  ...
  static bool get isAMOLEDTheme => LunaSeaPreferences.THEME_AMOLED.read();
  static bool get useBorders => LunaSeaPreferences.THEME_AMOLED_BORDER.read();
  ...
  SystemUiOverlayStyle get overlayStyle {
    return SystemUiOverlayStyle(
      systemNavigationBarColor: LunaSeaPreferences.THEME_AMOLED.read()
          ? Colors.black
          : LunaColours.secondary,
      systemNavigationBarDividerColor: LunaSeaPreferences.THEME_AMOLED.read()
          ? Colors.black
          : LunaColours.secondary,
