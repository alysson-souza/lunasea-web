...
abstract class LunaDialog {
  ...
  static RichText richText({
    ...
    text: TextSpan(
      style: const TextStyle(fontSize: LunaDialog.BODY_SIZE),
      children: children,
    ),
    textAlign: alignment,
  );
  ...
  static Widget cancel(
    ...
    child: Text(
      ...
      style: TextStyle(color: textColor, fontSize: LunaDialog.BUTTON_SIZE),
    ),
    onPressed: () {
      HapticFeedback.lightImpact();
  ...
  static Widget textContent({
    ...
    text,
    style: const TextStyle(color: Colors.white, fontSize: LunaDialog.BODY_SIZE),
    textAlign: textAlign,
  );
    ...
    decoration: InputDecoration(
      ...
      enabledBorder: UnderlineInputBorder(
        borderSide: BorderSide(
          color: LunaColours.accent.withValues(alpha: LunaUI.OPACITY_SPLASH),
        ),
      ),
    ),
    style: const TextStyle(color: Colors.white, fontSize: LunaDialog.BODY_SIZE),
  ...
  static CheckboxListTile checkbox({
    ...
    title: Text(
      title,
      style: const TextStyle(fontSize: BODY_SIZE, color: Colors.white),
    ),
    value: value,
    onChanged: onChanged,
    contentPadding: tileContentPadding(),
