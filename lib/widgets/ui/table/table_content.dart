...
class BackendPreferenceGroupContent extends StatelessWidget {
  final String? title;
  final String? body;
  final String? url;
  ...
  const BackendPreferenceGroupContent._({
    Key? key,
    this.title,
    this.body,
    this.url,
  ...
  factory BackendPreferenceGroupContent.spacer({
    Key? key,
    double spacerSize = LunaUI.DEFAULT_MARGIN_SIZE,
  }) =>
      BackendPreferenceGroupContent._(
        key: key,
        type: _Type.SPACER,
        spacerSize: spacerSize,
      );

  factory BackendPreferenceGroupContent({
    Key? key,
    String? title,
